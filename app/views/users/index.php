...
<body class="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-gray-100 font-sans min-h-screen">
  ...
  <div class="max-w-6xl mx-auto mt-10 px-4">
    ...
    <div class="bg-gray-800/80 backdrop-blur-xl shadow-2xl rounded-2xl p-8 border border-gray-700">

      <!-- Logged In User Display -->
      <?php if(!empty($logged_in_user)): ?>
        <div class="mb-8 bg-gradient-to-r from-gray-700 to-gray-800 text-white px-6 py-5 rounded-xl shadow-md text-center">
      ...
      <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        ...
        <form method="get" action="<?=site_url('users');?>" class="flex w-full md:w-auto">
          <input 
            ...
            class="w-full border border-gray-700 bg-gray-900 rounded-l-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-100">
      ...
      <!-- Table -->
      <div class="overflow-x-auto rounded-xl border border-gray-700 shadow-sm">
                ...
                <td class="py-3 px-4 space-x-3">
                  <?php if($logged_in_user['role'] === 'admin' || $logged_in_user['id'] == $user['id']): ?>
                    <a href="<?=site_url('users/update/'.$user['id']);?>"
                       class="px-3 py-1 text-sm rounded-lg bg-blue-900 text-blue-300 hover:bg-blue-700 hover:text-white transition duration-200 shadow-sm">
                      Update
                    </a>
                  <?php endif; ?>
                  ...
                  <?php if($logged_in_user['role'] === 'admin'): ?>
                    <a href="<?=site_url('users/delete/'.$user['id']);?>"
                       ...
                       class="px-3 py-1 text-sm rounded-lg bg-red-900 text-red-300 hover:bg-red-700 hover:text-white transition duration-200 shadow-sm">
                      Delete
                    </a>
                  <?php endif; ?>
                </td>
